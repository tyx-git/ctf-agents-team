...
4. 合并完成后执行 `python3 .skills/ctf-agents-team/scripts/ClearExp.py $COMPETITION_DIR` 清理所有 `exp_candidate.jsonl`
...
2. 运行 `python3 .skills/ctf-agents-team/scripts/status.py $COMPETITION_DIR --json` 查看已产出文件
