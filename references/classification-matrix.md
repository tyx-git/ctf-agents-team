...
|---------------------|------|-----------|-----------|
| `.pcap/.pcapng/.evtx/.raw/.dd/.E01`, memory dump, disk image, "packet/spectrogram/side-channel" | Forensics | `forensics-agent` | PCAP 分析、内存取证、磁盘取证、侧信道 |
...
| PCAP + 编码层 | 先 Forensics 提取，再 Misc 解码 |
...
- 连续两个检查点无新发现 → 触发 Pivot 或 Abandoned
